...
func TestContractMintToContract(t *testing.T) {
	...
	assert.Equal(itest.CurrentTest(), xdr.Uint64(math.MaxUint64-3), (*balanceAmount))
	...
	assert.Equal(itest.CurrentTest(), xdr.Uint64(math.MaxUint64), (*balanceAmount))
	//assert.Equal(itest.CurrentTest(), xdr.ScValTypeScvI128, balanceAmount.Type)
...
func TestContractTransferBetweenAccountAndContract(t *testing.T) {
	...
	assert.Equal(itest.CurrentTest(), xdr.Uint64(5300000000), (*balanceAmount))
	//assert.Equal(itest.CurrentTest(), xdr.ScValTypeScvI128, balanceAmount.Type)
...
func TestContractTransferBetweenContracts(t *testing.T) {
	...
	assert.Equal(itest.CurrentTest(), xdr.Uint64(9900000000), (*emitterBalanceAmount))
	...
	assert.Equal(itest.CurrentTest(), xdr.Uint64(100000000), (*recipientBalanceAmount))
...
func assertInvokeHostFnSucceeds(itest *integration.Test, signer *keypair.Full, op *txnbuild.InvokeHostFunction) (*xdr.Hash, string) {
	...
	firstSuccessScVal := (*invokeHostFunctionResult.Success)
